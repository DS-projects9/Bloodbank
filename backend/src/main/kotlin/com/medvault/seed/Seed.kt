...
object Seed {
    ...
    private val demos = listOf(
        Demo(
            "dr.alice@medvault.dev", "DOCTOR", "Dr. Alice Mehta",
            mapOf(
        ...
        Demo(
            "dr.bob@medvault.dev", "DOCTOR", "Dr. Bob Nair",
            mapOf(
        ...
        Demo(
            "bb.redcross@medvault.dev", "BLOOD_BANK", "Red Cross Blood Bank",
            mapOf(
        ...
        Demo(
            "bb.lifeline@medvault.dev", "BLOOD_BANK", "LifeLine Blood Bank",
            mapOf(
        ...
        Demo(
            "bb.care@medvault.dev", "BLOOD_BANK", "Care Blood Center",
            mapOf(
        ...
        Demo(
            "patient@medvault.dev", "PATIENT", "Test Patient",
            mapOf(
